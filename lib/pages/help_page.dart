...
- 📱 **グループタップ**: カレントグループに設定
  ...
  - 「カレント」バッジ表示
  - 成功メッセージ表示
- 📱 **グループダブルタップ**: メンバー管理画面に遷移
- 📱 **グループ長押し**: オーナーは削除、メンバーは退出
- 📱 **右下+ボタンタップ**: 新規グループ作成
...
- 📱 **アイテムタップ**: 購入状態切り替え
- 📱 **アイテムダブルタップ**: 編集画面を開く
- 📱 **アイテム長押し**: 削除確認ダイアログを表示
- 📱 **右下+ボタンタップ**: 新規アイテム追加

## 👤 メンバー管理画面

### グループ鍵ローテーション
- 📱 **鍵ローテーションボタン（🔑↻）タップ**（オーナーのみ表示）:
  - グループの暗号化鍵を再作成
  - 新しい鍵をすべてのメンバーに自動配布
  - セキュリティを強化（定期的な鍵更新）
  - 配布処理中は画面がロック表示される
...
### メンバーリスト
- 📱 **メンバータップ**: メンバー情報表示（オーナーの場合はロール変更ダイアログ）
- 📱 **メンバーダブルタップ**: ホワイトボードを開く
  - 自分のタイル: 個人用ホワイトボードを編集
  - 他のメンバー: そのメンバーのホワイトボードを閲覧
- 📱 **削除ボタンタップ**: メンバー削除（確認あり）

### ロール変更（オーナー専用）
- メンバータイルをタップするとロール変更ダイアログが表示されます
- **メンバー → マネージャー**: 招待・リスト編集権限を付与
- **マネージャー → メンバー**: 管理権限を取り消し
...
| 操作 | 動作 |
|------|------|
| **タップ** | メインアクション（選択・状態切替・確認） |
| **ダブルタップ** | サブアクション（編集・詳細・ホワイトボード） |
| **長押し** | 削除・退出などの破壊的操作（確認ダイアログあり） |

### 画面別 早見表

| 画面 | タップ | ダブルタップ | 長押し |
|------|--------|-------------|--------|
| グループ一覧 | カレント選択 | メンバー管理画面へ | 削除/退出 |
| メンバー一覧 | ロール変更（オーナーのみ）/ 情報表示 | ホワイトボードを開く | — |
| アイテム一覧 | 購入状態切替 | 編集画面へ | 削除 |
...
## グループを削除する
1. グループを **長押し**
2. オーナーは「削除」、メンバーは「退出」を選択
3. 確認ダイアログで実行

⚠️ オーナーはグループを削除できます。メンバーは自分だけ退出できます。
''',
...
### メンバータイルの操作
- 📱 **メンバータップ（オーナーのみ）**: ロール変更ダイアログを表示
  - メンバー → マネージャーに昇格
  - マネージャー → メンバーに降格
- 📱 **メンバータップ（一般）**: メンバー情報を表示
- 📱 **メンバーダブルタップ**: ホワイトボードを開く
  - 自分のタイル: 個人用ホワイトボードを編集
  - 他のメンバーのタイル: そのメンバーのホワイトボードを閲覧

### メンバーリスト表示
- 📱 **メンバーカード**: 名前、役割、連絡先表示
- 📱 **役割バッジ**: オーナー（赤）・マネージャー（橙）・パートナー（紫）・メンバー（青）
...
**Q: 何人までメンバーを追加できますか？**
A: Freeプランでは1グループにつき10人までです。Premiumプランでは上限はありません。
