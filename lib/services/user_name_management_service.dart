...
class UserNameManagementService {
  ...
  static Future<bool> saveUserName(String userName, WidgetRef ref) async {
    return await ErrorHandler.handleAsync(
          ...
          context: 'USER_NAME_MGT:saveUserName',
          defaultValue: false,
        ) ??
        false;
  }
  ...
  static Future<String?> restoreUserName({
    ...
    return ErrorHandler.handleAsync<String>(
      ...
      context: 'USER_NAME_MGT:restoreUserName',
      defaultValue: null,
    );
  }
  ...
  static String? getUserNameFromGroup({
    ...
    return ErrorHandler.handleSync<String>(
      operation: () {
      ...
      context: 'USER_NAME_MGT:getUserNameFromGroup',
      defaultValue: null,
    );
  }
  ...
  static Future<void> updateUserNameInAllGroups({
    ...
    await ErrorHandler.handleAsync(
      ...
      context: 'USER_NAME_MGT:updateUserNameInAllGroups',
      defaultValue: null,
    );
  }
}
