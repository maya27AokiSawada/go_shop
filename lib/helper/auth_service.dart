...
import 'package:firebase_auth/firebase_auth.dart' if (dart.library.io) 'firebase_stub.dart';
...
class AuthService {
  ...
  Future<UserCredential> signInWithEmail(String email, String password) async {
    throw UnimplementedError('AuthService should not be used in dev mode. Use MockAuthService instead.');
  }
