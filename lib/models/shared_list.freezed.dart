...
mixin _$SharedItem {
  ...
  @JsonKey(ignore: true)
  $SharedItemCopyWith<SharedItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SharedItemCopyWith<$Res> {
  factory $SharedItemCopyWith(
          SharedItem value, $Res Function(SharedItem) then) =
      _$SharedItemCopyWithImpl<$Res, SharedItem>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SharedItemCopyWithImpl<$Res, $Val extends SharedItem>
    implements $SharedItemCopyWith<$Res> {
  _$SharedItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SharedItemImplCopyWith<$Res>
    implements $SharedItemCopyWith<$Res> {
  factory _$$SharedItemImplCopyWith(
          _$SharedItemImpl value, $Res Function(_$SharedItemImpl) then) =
      __$$SharedItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@HiveField(0) String memberId,
...
/// @nodoc
class __$$SharedItemImplCopyWithImpl<$Res>
    extends _$SharedItemCopyWithImpl<$Res, _$SharedItemImpl>
    implements _$$SharedItemImplCopyWith<$Res> {
  __$$SharedItemImplCopyWithImpl(
      _$SharedItemImpl _value, $Res Function(_$SharedItemImpl) _then)
      : super(_value, _then);
...
class _$SharedItemImpl implements _SharedItem {
  const _$SharedItemImpl(
...
// 🆕 論理削除フラグ
  ...
  @override
  String toString() {
    return 'SharedItem(memberId: $memberId, name: $name, quantity: $quantity, registeredDate: $registeredDate, purchaseDate: $purchaseDate, isPurchased: $isPurchased, shoppingInterval: $shoppingInterval, deadline: $deadline, itemId: $itemId, isDeleted: $isDeleted, deletedAt: $deletedAt)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SharedItemImplCopyWith<_$SharedItemImpl> get copyWith =>
      __$$SharedItemImplCopyWithImpl<_$SharedItemImpl>(this, _$identity);
}

abstract class _SharedItem implements SharedItem {
  const factory _SharedItem(
      ...
      @HiveField(10) final DateTime? deletedAt}) = _$SharedItemImpl;
...
mixin _$SharedList {
  ...
  @HiveField(3)
  Map<String, SharedItem> get items =>
...
abstract class $SharedListCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(3) Map<String, SharedItem> items,
...
class _$SharedListImpl extends _SharedList {
  const _$SharedListImpl(
      ...
      @HiveField(3) final Map<String, SharedItem> items = const {},
  ...
  final Map<String, SharedItem> _items;
  @override
  @JsonKey()
  @HiveField(3)
  Map<String, SharedItem> get items {
...
// 追加: 更新日時
  ...
  @override
  String toString() {
    return 'SharedList(ownerUid: $ownerUid, groupId: $groupId, groupName: $groupName, items: $items, listId: $listId, listName: $listName, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, listType: $listType)';
  }
...
abstract class _SharedList extends SharedList {
  const factory _SharedList(
      ...
      @HiveField(3) final Map<String, SharedItem> items,
      ...
      @HiveField(9) final ListType listType}) = _$SharedListImpl;
  const _SharedList._() : super._();
