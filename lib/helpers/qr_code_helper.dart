...
class QrCodeHelper {
  ...
  static void handleQrCodeScan(
      BuildContext context, WidgetRef ref, VoidCallback onShowSignUp) {
    ...
    UiHelper.showInfoMessage(context, 'QRコード機能は開発中です',
  ...
  static Future<void> processPendingInvitation(
