...
class FirestoreCollections {
  ...
  static CollectionReference<Map<String, dynamic>> getUserPurchaseGroups(String ownerUid) {
  ...
  static CollectionReference<Map<String, dynamic>> getUserShoppingLists(String ownerUid) {
    return FirebaseFirestore.instance
        .collection(users)
        .doc(ownerUid)
  ...
  static DocumentReference<Map<String, dynamic>> getPurchaseGroupDoc(String ownerUid, String groupId) {
    return getUserPurchaseGroups(ownerUid).doc(groupId);
  }
  
  /// Get specific shopping list document reference
  static DocumentReference<Map<String, dynamic>> getShoppingListDoc(String ownerUid, String listId) {
